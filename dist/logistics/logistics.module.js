...
LogisticsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([logistic_entity_1.Logistic]), common_module_1.CommonModule],
        controllers: [logistics_controller_1.LogisticsController],
        providers: [logistics_service_1.LogisticsService],
        exports: [typeorm_1.TypeOrmModule, logistics_service_1.LogisticsService],
    })
], LogisticsModule);
