...
CarsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([car_entity_1.Car]), common_module_1.CommonModule, logistics_module_1.LogisticsModule],
        controllers: [cars_controller_1.CarsController],
        providers: [cars_service_1.CarsService],
        exports: [typeorm_1.TypeOrmModule, cars_service_1.CarsService],
    })
], CarsModule);
